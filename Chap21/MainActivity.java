...
public class MainActivity extends AbstractJni {
    ...
    public MainActivity(){
        ...
        vm = emulator.createDalvikVM(new File("unidbg-android/src/test/java/com/dta/lesson31/fourth.apk"));
        vm.setVerbose(true);
        vm.setJni(this);

        DalvikModule dalvikModule = vm.loadLibrary(new File("unidbg-android/src/test/java/com/dta/lesson31/libphcm.so"), false);
