...
Java_com_dta_lesson2_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_dta_lesson2_MainActivity_md52(JNIEnv *env, jobject thiz, jbyteArray data) {
    // TODO: implement md52()
    ...
    jclass MainActivity = env->FindClass("com/dta/lesson2/MainActivity");
